  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl">
      <h2 className="text-2xl font-semibold text-center text-gray-800 mb-4">🛠 Process Order</h2>
        <div className="text-center hidden md:grid grid-cols-4 gap-3 px-3 py-2 bg-gray-100 rounded-md font-semibold text-gray-700 text-sm">
        ...
        <div className="text-center space-y-3 mt-2">
            ...
            return (
                <div key={item.id} className="grid grid-cols-1 md:grid-cols-4 gap-9 items-center bg-gray-50 p-3 rounded-lg shadow-sm border border-gray-200">
